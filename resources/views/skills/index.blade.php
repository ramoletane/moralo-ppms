    ...
    <div class="max-w-3xl mx-auto p-4 sm:p-6 lg:p-8">
        ...
        <div class="mt-6 p-6 bg-white shadow-sm rounded-lg">
            ...
            <table class="table-auto w-full">
                <thead>
                    <tr>
                        <th class="border text-left px-2 bg-slate-100">Skills</th>
...
{{--                            @if ($skill->user->is(auth()->user())) --}}
                                <x-dropdown>
                                    ...
                                    <x-slot name="content">
                                        ...
                                        <form skill="POST" action="{{ route('skills.destroy',$skill) }}">
                                            @csrf
                                            @skill('delete')
                                            <x-dropdown-link :href="route('skills.destroy',$skill)" onclick="event.preventDefault(); this.closest('form').submit();">
                                                {{ __('Delete') }}
                                            </x-dropdown-link>
                                        </form>
                                    </x-slot>
